...
- **Slide 02 — Front view**: bg `#EEE8DA`, 80px/140px padding. Header row: title 48px left, subtitle 24px `#7D6F5B` right, 2px `#211A16` bottom border, 24px padding-bottom. Diagram SVG centered, full remaining height.
